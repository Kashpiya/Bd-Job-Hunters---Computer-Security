...
div.popup-container div.popup div.forhot-btn button{
	border: none;
...
<form action="loginprocess.php" method="post">
  ...
  <div class="container" style="background-color:#f1f1f1">
    ...
    <button type="button" class="cancelbtn" onclick="resetpwfn()">Reset Password</button>
...
<script>
   ...
   <script>
            function resetpwfn() {
                location.assign('resetpassword.php.php'); ///GET method
            }
        </script>
